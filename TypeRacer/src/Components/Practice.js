...
const Practice = () => {
  const apiUrl = "https://api.quotable.io/random"; //random quotes
  ...
  {/*Information above typing snetences */}
      <section className="information">
        <p>
          Press <span>Enter</span> to reset and change sentences.
        </p>
      ...
      {/*typing result imported from snackbar */}
      <Snackbar
        ref={snackbarRef}
        data={
